...
class JobDescriptionGenerator:
    ...
    def __init__(self, config_file_path):
        ...
        # self.connect_to_database()  # This is commented out, for future use as the database connection is done in separate file

    def load_config(self):
        """Load configuration from a JSON file"""
        with open(self.config_file_path, 'r') as config_file:
            self.config = json.load(config_file)
            self.openai_key = self.config['OpenAI']['key']
    ...
    def generated_job_description(self):
        try:
            ...
            return "Job Description has been generated..!"
...
if __name__ == "__main__":
    ...
    generator.generated_job_description()
